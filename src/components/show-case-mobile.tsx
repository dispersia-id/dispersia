...
const HorizontalScrollCarousel = () => {
  ...
  return (
    <section
      ref={targetRef}
      className='relative h-[900vh] bg-background m-auto flex flex-col md:flex-row md:hidden'
    >
      <div className='sticky w-full flex flex-col top-0 h-screen items-center overflow-hidden'>
        <div>
          <h1 className='text-2xl font-black text-white font-plus-jakarta-sans mb-4 text-center'>
            dispersia
          </h1>
        ...
        <div className='ml-auto overflow-hidden'>
          <motion.div style={{ x }} className='flex gap-4 overflow-auto'>
            {content.map((card) => {
      ...
      <div className='sticky w-full flex flex-col top-10 h-screen items-center overflow-hidden'>
